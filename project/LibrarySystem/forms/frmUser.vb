Public Class frmUser
    ...
    Private Sub frm_adduser_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            reloadDtg("Select UserId as 'ID' ,Username as 'Name',Email as 'UserName',UserRole as 'Type' From tbluser WHERE Status='Active'", dtg_listUser)
    ...
    Private Sub btn_saveuser_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_saveuser.Click
        ...
        If txt_name.Text = "" Or txt_pass.Text = "" Or txt_username.Text = "" Then
            emptymessage()
        Else
            result = create("insert into tbluser (`Username`, `Email`, `Password`, `UserRole`,`Status`) " _
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        Try
            If txt_name.Text = "" Or txt_pass.Text = "" Or txt_username.Text = "" Then
                emptymessage()
            Else
                result = updates("update tbluser set Username = '" & txt_name.Text & "',Email= '" & txt_username.Text _
                            & "',Password= sha1('" & txt_pass.Text & "'),UserRole= '" & cbo_type.Text _
